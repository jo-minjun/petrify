...
- Added SupernoteX parser adapter (`@petrify/parser-supernote-x`) and wired it into parser selection
...
[Unreleased]: https://github.com/jo-minjun/petrify/compare/0.5.0...HEAD
[0.5.0]: https://github.com/jo-minjun/petrify/compare/0.4.0...0.5.0
